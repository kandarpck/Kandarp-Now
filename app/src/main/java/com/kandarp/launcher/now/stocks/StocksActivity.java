package com.kandarp.launcher.now.stocks;
 ...
 */
public class StocksActivity extends FragmentActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setQueryHint("Eg: GE, AAPL, MSFT");
    ...
    private class GetKeyStatsAsyncTask1 extends AsyncTask<String, String, Stock> {
