...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        // content://com.kandarp.launcher.now/weather/
        String type = mContext.getContentResolver().getType(WeatherEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.kandarp.launcher.now/weather
        assertEquals(WeatherEntry.CONTENT_TYPE, type);

        String testLocation = "94074";
        // content://com.kandarp.launcher.now/weather/94074
        ...
        // content://com.kandarp.launcher.now/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/com.kandarp.launcher.now/weather
        assertEquals(WeatherEntry.CONTENT_ITEM_TYPE, type);

        // content://com.kandarp.launcher.now/location/
        type = mContext.getContentResolver().getType(LocationEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.kandarp.launcher.now/location
        assertEquals(LocationEntry.CONTENT_TYPE, type);

        // content://com.kandarp.launcher.now/location/1
        type = mContext.getContentResolver().getType(LocationEntry.buildLocationUri(1L));
        // vnd.android.cursor.item/com.kandarp.launcher.now/location
